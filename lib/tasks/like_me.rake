...
task :like_me => :environment do
  ...
  class LikeMe
    ...
    page = mechanize.get('https://www.instagram.com/')
    binding.pry
# puts page.at('.entry-title').text.strip
#       # url_list.each do |url|
#         @page = Nokogiri::HTML(open("https://www.instagram.com/explore/locations/213353656/washington-dulles-international-airport/", "User-Agent" => @user_agent.sample[0] ))
#         # @url  = url
#         binding.pry
#         like_people
      #   clean_data
